class Filosofo extends Thread {
    ...
    private void tomarTenedores() {
        ...
        synchronized (tenedorIzquierdo) {
            ...
            System.out.println("Filosofo: " + this.id + " esta intentando pillar el tenedor derecho");
    ...
    private void comer() throws InterruptedException {
        System.out.println("Filosofo: " + this.id + " esta papeando");
        Thread.sleep((long) Math.random() * 1000);
    }

    private void soltarTenedores() {
        System.out.println("Filosofo: " + this.id + " esta soltando los tenedores");
    }
